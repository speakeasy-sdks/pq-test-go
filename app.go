...
func (s *app) C1APIAppV1AppEntitlementUserBindingServiceListAppUsersForIdentityWithGrant(ctx context.Context, appEntitlementID string, appID string, identityUserID string) (*operations.C1APIAppV1AppEntitlementUserBindingServiceListAppUsersForIdentityWithGrantResponse, error) {
...
func (s *app) C1APIAppV1AppEntitlementsGet(ctx context.Context, appID string, id string) (*operations.C1APIAppV1AppEntitlementsGetResponse, error) {
...
func (s *app) C1APIAppV1AppResourceServiceGet(ctx context.Context, appID string, appResourceTypeID string, id string) (*operations.C1APIAppV1AppResourceServiceGetResponse, error) {
...
func (s *app) C1APIAppV1AppResourceTypeServiceGet(ctx context.Context, appID string, id string) (*operations.C1APIAppV1AppResourceTypeServiceGetResponse, error) {
...
func (s *app) C1APIAppV1AppsGet(ctx context.Context, id string) (*operations.C1APIAppV1AppsGetResponse, error) {
